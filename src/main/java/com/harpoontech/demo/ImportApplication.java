...
import com.harpoontech.demo.config.AsyncConfiguration;
import com.harpoontech.demo.config.CacheConfiguration;
import com.harpoontech.demo.config.CloudDatabaseConfiguration;
import com.harpoontech.demo.config.Constants;
import com.harpoontech.demo.config.DatabaseConfiguration;
 ...
 *
 */
@SuppressWarnings({"Duplicates", "SpringFacetCodeInspection"})
@Configuration
@Import({
...
public class ImportApplication {
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ImportApplication.class);
